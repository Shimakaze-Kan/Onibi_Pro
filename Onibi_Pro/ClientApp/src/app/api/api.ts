...
export interface IAuthenticationClient {
     ...
     * @return Success
     */
    confirmEmail(code: string): Observable<void>;
}
...
export class AuthenticationClient implements IAuthenticationClient {
     ...
     */
    confirmEmail(code: string): Observable<void> {
        let url_ = this.baseUrl + "/api/Authentication/ConfirmEmail/{code}";
...
export interface IStatisticsClient {
     ...
     * @return Success
     */
    ingredientStatistics(): Observable<GetIngredientStatisticsResponse[]>;
    /**
     * @return Success
     */
    topMenuItems(): Observable<GetTopMenuItemsResponse[]>;
}
...
export class StatisticsClient implements IStatisticsClient {
     ...
     */
    ingredientStatistics(): Observable<GetIngredientStatisticsResponse[]> {
        let url_ = this.baseUrl + "/api/Statistics/IngredientStatistics";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processIngredientStatistics(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processIngredientStatistics(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GetIngredientStatisticsResponse[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetIngredientStatisticsResponse[]>;
        }));
    }

    protected processIngredientStatistics(response: HttpResponseBase): Observable<GetIngredientStatisticsResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(GetIngredientStatisticsResponse.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     */
    topMenuItems(): Observable<GetTopMenuItemsResponse[]> {
        let url_ = this.baseUrl + "/api/Statistics/TopMenuItems";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTopMenuItems(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTopMenuItems(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GetTopMenuItemsResponse[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetTopMenuItemsResponse[]>;
        }));
    }

    protected processTopMenuItems(response: HttpResponseBase): Observable<GetTopMenuItemsResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(GetTopMenuItemsResponse.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
export class TestClient implements ITestClient {
     ...
     */
    routes(): Observable<void> {
        let url_ = this.baseUrl + "/api/Test/routes";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRoutes(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRoutes(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processRoutes(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class GetIngredientStatisticsResponse implements IGetIngredientStatisticsResponse {
    ingredientName?: string | undefined;
    totalQuantity?: number;

    constructor(data?: IGetIngredientStatisticsResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetIngredientStatisticsResponse {
        data = typeof data === 'object' ? data : {};
        let result = new GetIngredientStatisticsResponse();
        result.init(data);
        return result;
    }
...
export interface IGetIngredientStatisticsResponse {
    ingredientName?: string | undefined;
    totalQuantity?: number;
}

export class GetTopMenuItemsResponse implements IGetTopMenuItemsResponse {
    restaurantId?: string;
    menuItemName?: string | undefined;
    ordersCount?: number;

    constructor(data?: IGetTopMenuItemsResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetTopMenuItemsResponse {
        data = typeof data === 'object' ? data : {};
        let result = new GetTopMenuItemsResponse();
        result.init(data);
        return result;
    }
...
export interface IGetTopMenuItemsResponse {
    restaurantId?: string;
    menuItemName?: string | undefined;
    ordersCount?: number;
}
