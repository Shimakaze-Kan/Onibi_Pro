...
internal sealed class PopulateUserToMasterDbEventHandler : INotificationHandler<UserCreated>
{
    private readonly IMasterDbRepository _masterDbRepository;
    private readonly ICurrentUserService _currentUserService;

    public PopulateUserToMasterDbEventHandler(IMasterDbRepository masterDbRepository,
