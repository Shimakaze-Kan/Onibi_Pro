...
namespace Onibi_Pro.Infrastructure.Migrations
{
    ...
    [Migration("20231230011522_Migration_20231230021413")]
    partial class Migration_20231230021413
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Onibi_Pro.Domain.PackageAggregate.Package", b =>
                {
                    b.HasOne("Onibi_Pro.Domain.RestaurantAggregate.Restaurant", null)
                        .WithOne()
                        .HasForeignKey("Onibi_Pro.Domain.PackageAggregate.Package", "DestinationRestaurant")
